...
- **Android APK**: `releases/WSPRSpyDX-v0.38-debug.apk` is a debug-signed test build that bundles the same dashboard inside a small Android WebView app.
...
```text
releases/WSPRSpyDX-v0.38-debug.apk
```
