...
- **Android APK**: `releases/WSPRSpyDX-v0.50-debug.apk` is a debug-signed test build that bundles the dashboard and Android-only CW RBN Monitor inside a small Android WebView app.
...
```text
releases/WSPRSpyDX-v0.50-debug.apk
```
